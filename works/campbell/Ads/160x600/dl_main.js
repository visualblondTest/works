...
var imageArray = new Array(
    ...
    "img/bar-3.png", "img/smoke.png", "img/cta.png", "img/cta-arrow.png", "img/txt-1.png", "img/txt-2.png", "img/txt-3.png", "img/txt-4.png", "img/txt-5.png", "img/txt-6.png", "img/img-2.jpg", "img/img-3.jpg"
...
function endFrame(){
    ...
    _tt_endFrame
    .set("[id*='txt-']", {clip: "rect(0px 160px 600px 0px"})
    .from("#txt-1", 1 , { clip: "rect(0px 0px 600px 0px", ease: Power4.easeOut }, 0)
    .from("#txt-2", 1 , { clip: "rect(0px 160px 600px 160px", ease: Power4.easeOut }, 0.3)
    .from("#txt-3", 1 , { clip: "rect(0px 0px 600px 0px", ease: Power4.easeOut }, 0.6)
    .from("#txt-4", 1 , { clip: "rect(0px 160px 600px 160px", ease: Power4.easeOut }, 0.9)
    .from("#txt-5", 1 , { clip: "rect(0px 0px 600px 0px", ease: Power4.easeOut }, 1.2)
    .from("#txt-6", 1 , { clip: "rect(0px 160px 600px 160px", ease: Power4.easeOut }, 1.5)
