...
var imageArray = new Array(
    "img/img-1.png", "img/product.png", "img/bar-1.png", "img/bar-2.png", 
    "img/bar-3.png", "img/smoke.png", "img/cta.png", "img/cta-arrow.png", "img/txt-1.png"
    , "img/txt-2.png", "img/txt-3.png", "img/img-2.png", "img/img-3.png", "img/img-3-spoon.png"
...
function fr1(){
  ...
  //  .from("#img-1-spoon", 2 , { y: 10, x: -15, scale: 0.95, ease: Power3.easeInOut }, 0.1)
    .to("#img-1-spoon", 1 , { y: 5, repeat: -1, yoyo: true, ease: Linear.easeNone }, 0)
...
function fr3(){
    ...
    .to("#img-3-spoon", 1.5 , { y: 5, repeat: -1, yoyo: true, ease: Linear.easeNone }, 0)
...
function endFrame(){
    ...
    _tt_endFrame
    .set("[id*='txt-']", {clip: "rect(0px 300px 250px 0px"})
    .from("#txt-1", 1 , { clip: "rect(0px 0px 250px 0px", ease: Power4.easeOut }, 0)
    .from("#txt-2", 1 , { clip: "rect(0px 300px 250px 300px)", ease: Power4.easeOut }, 0.3)
    .from("#txt-3", 1 , { clip: "rect(0px 0px 250px 0px", ease: Power4.easeOut }, 0.6)
    .from("#txt-4", 1 , { clip: "rect(0px 300px 250px 300px)", ease: Power4.easeOut }, 0.9);
...
return _tt_endFrame
    ...
    _tt_globalSmoke
    .staggerFromTo("[id*='smoke-1-']", 3 , { opacity: 0 }, { opacity: 1, scale: 1.05, y: -200, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
    .staggerFromTo("[id*='smoke-2-']", 3 , { opacity: 0 }, { opacity: 1, scale: 1.05, y: -200, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
    .staggerFromTo("[id*='smoke-3-']", 3 , {x: -50, y: 60, opacity: 0 }, { x: -60, opacity: 1, scale: 1.15, y: -250, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
