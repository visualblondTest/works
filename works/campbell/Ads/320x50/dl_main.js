...
var imageArray = new Array(
    ...
    "img/bar-3.png", "img/smoke.png", "img/cta.png", "img/cta-arrow.png", "img/txt-1.png", "img/txt-2.png", "img/img-2.png", "img/img-3.png"
...
function endFrame(){
    ...
    _tt_endFrame
    .set("[id*='txt-']", {clip: "rect(0px 320px 50px 0px"})
    .to("#bar-3", 1 , { y: -100, rotation: 0.01, ease: Power4.easeOut }, 0)
    .from("#txt-1", 2 , { clip: "rect(0px 0px 50px 0px", ease: Power4.easeOut }, 0.3)
    .from("#txt-2", 2 , { clip: "rect(0px 0px 50px 0px", ease: Power4.easeOut }, 0.6)
...
return _tt_endFrame
    ...
    _tt_globalSmoke
    .staggerFromTo("[id*='smoke-1-']", 5 , { opacity: 0 }, { opacity: 0.5, scale: 1.05, y: -250, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
    .staggerFromTo("[id*='smoke-2-']", 5 , { opacity: 0 }, { opacity: 0.5, scale: 1.05, y: -250, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
    .staggerFromTo("[id*='smoke-3-']", 5 , {x: -150, y: 60, opacity: 0 }, { x: -60, opacity: 0.5, scale: 1.15, y: -250, repeat: -1, ease: Linear.easeNone }, 0.5, 0)
...
/*-------*/
    ...
    clicktag.addEventListener('mouseover', function(event) {
            TweenMax.to("#cta-arrow", 0.2 , { x: 2, repeat: -1, yoyo: true, ease: Linear.easeNone }, 0)
