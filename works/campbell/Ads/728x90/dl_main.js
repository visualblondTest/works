...
var imageArray = new Array(
    ...
    "img/bar-3.png", "img/smoke.png", "img/cta.png", "img/cta-arrow.png", "img/txt-1.png", "img/img-2.png", "img/img-3.png"
...
function endFrame(){
    ...
    _tt_endFrame
    .set("[id*='txt-']", {clip: "rect(0px 728px 90px 0px"})
    .from("#txt-1", 2 , { clip: "rect(0px 0px 90px 0px", ease: Power4.easeOut }, 0)
