FORGE.init = function() {
  ...
  FORGE.preloadImages(images, true, function() {
    ...
    var photo_1 = FORGE.createElement({width: 300, height: 600, parent: banner});
      var photo_1_bg = FORGE.createElement({backgroundImage: "photo_1_bg.jpg", parent: photo_1});
    var stamp_locomotive = FORGE.createElement({width: 394, height: 351, left: 70, top: 526, parent: banner});
    var photo_2 = FORGE.createElement({width: 381, height: 600, parent: banner});
      ...
      var photo_2_wheel = FORGE.createElement({backgroundImage: "photo_2_wheel.png", left: -49, top: 101, parent: photo_2});
      var photo_2_axle = FORGE.createElement({backgroundImage: "photo_2_axle.png", top: 213, width: 180, height: 100, parent: photo_2});
      var photo_2_gradient = FORGE.createElement({backgroundImage: "photo_2_gradient.png", top: 207, width: 300, height: 300, parent: photo_2});
    var separator_1 = FORGE.createElement({width: 98, height: 14, left: 38, top: 475, parent: banner});
    ...
    var txt_1 = FORGE.createElement({width: 117, height: 16, left: 27, top: 28, parent: banner});
      var txt_1_1 = FORGE.createElement({width: 175, height: 41, parent: txt_1});
        var txt_1_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 175, height: 41, opacity: 0, parent: txt_1_1});
        var txt_1_1_txt = FORGE.createElement({backgroundImage: "txt_1_1_txt.png", left: 5, top: 4, retina: true, parent: txt_1_1});

    var txt_2 = FORGE.createElement({width: 300, height: 152, left: -6, top: 338, parent: banner});

      var txt_2_1 = FORGE.createElement({width: 300, height: 35, parent: txt_2});
        var txt_2_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 300, height: 35, opacity: 0, parent: txt_2_1});
        var txt_2_1_base = FORGE.createElement({backgroundImage: "txt_2_1_base.png", left: 5, top: 0, retina: true, parent: txt_2_1});

      var txt_2_2 = FORGE.createElement({width: 300, height: 35, top: 40, parent: txt_2});
        var txt_2_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 300, height: 35, opacity: 0, parent: txt_2_2});
        var txt_2_2_base = FORGE.createElement({backgroundImage: "txt_2_2_base.png", left: 5, top: 0, retina: true, parent: txt_2_2});

      var txt_2_3 = FORGE.createElement({width: 300, height: 35, top: 80, parent: txt_2});
        var txt_2_3_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 300, height: 35, opacity: 0, parent: txt_2_3});
        var txt_2_3_base = FORGE.createElement({backgroundImage: "txt_2_3_base.png", left: 5, top: 0, retina: true, parent: txt_2_3});

      var txt_2_4 = FORGE.createElement({width: 300, height: 35, top: 120, parent: txt_2});
        var txt_2_4_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 300, height: 35, opacity: 0, parent: txt_2_4});
        var txt_2_4_base = FORGE.createElement({backgroundImage: "txt_2_4_base.png", left: 5, top: 0, retina: true, parent: txt_2_4});

    var txt_3 = FORGE.createElement({width: 220, height: 151, left: 39, top: 300, parent: banner});
      var txt_3_1 = FORGE.createElement({width: 221, height: 33, parent: txt_3});
        var txt_3_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 221, height: 33, opacity: 0, parent: txt_3_1});
        var txt_3_1_base = FORGE.createElement({backgroundImage: "txt_3_1_base.png", left: 0, top: 0, retina: true, parent: txt_3_1});

      var txt_3_2 = FORGE.createElement({width: 221, height: 33, top: 40, parent: txt_3});
        var txt_3_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 221, height: 33, opacity: 0, parent: txt_3_2});
        var txt_3_2_base = FORGE.createElement({backgroundImage: "txt_3_2_base.png", left: 0, top: 0, retina: true, parent: txt_3_2});

      var txt_3_3 = FORGE.createElement({width: 221, height: 33, top: 80, parent: txt_3});
        var txt_3_3_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 221, height: 33, opacity: 0, parent: txt_3_3});
        var txt_3_3_base = FORGE.createElement({backgroundImage: "txt_3_3_base.png", left: 0, top: 0, retina: true, parent: txt_3_3});

      var txt_3_4 = FORGE.createElement({width: 221, height: 33, top: 120, parent: txt_3});
        var txt_3_4_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 221, height: 33, opacity: 0, parent: txt_3_4});
        var txt_3_4_base = FORGE.createElement({backgroundImage: "txt_3_4_base.png", left: 0, top: 0, retina: true, parent: txt_3_4});

    var panel = FORGE.createElement({width: 300, height: 600, left: 0, top: 0, parent: banner});
    var photo_3_bg = FORGE.createElement({backgroundImage: "photo_3_bg.jpg", width: 300, height: 600, left: 0, top: 0, parent: panel});

      var panel_base = FORGE.createElement({backgroundColor: "#333333", width: 288, height: 582,left: 6, top: 9, opacity: 0.9, parent: panel});
      var logo_locomotive = FORGE.createElement({width: 223, height: 198, left: 39, top: 186, parent: panel});
      ...
      var separator_2 = FORGE.createElement({width: 159, height: 12, left: 72, top: 490, parent: panel});
        var separator_1_3 = FORGE.createElement({backgroundImage: "separator_1_3.png", left: 0, top: 2, retina: true, parent: separator_2});

      var txt_4 = FORGE.createElement({width: 192, height: 57, left: 101, top: 423, parent: panel});
        var txt_4_1 = FORGE.createElement({width: 110, height: 25, parent: txt_4});
          var txt_4_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 110, height: 25, opacity: 0, parent: txt_4_1});
          var txt_4_1_base = FORGE.createElement({backgroundImage: "txt_4_1_base.png", left: 0, top: 0, retina: true, parent: txt_4_1});

        var txt_4_2 = FORGE.createElement({width: 192, height: 23, top: 33, left: -40, parent: txt_4});
          var txt_4_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 192, height: 23, opacity: 0, parent: txt_4_2});
          var txt_4_2_base = FORGE.createElement({backgroundImage: "txt_4_2_base.png", left: 0, top: 0, retina: true, parent: txt_4_2});

      var cta = FORGE.createElement({width: 132, height: 34, left: 85, top: 435, parent: panel});
