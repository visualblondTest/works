FORGE.init = function() {
  ...
  FORGE.preloadImages(images, true, function() {
    ...
    /* Create elements
    ================================================= */
    var bg = FORGE.createElement({backgroundColor: "#333333", width: 300, height: 600, parent: banner});
    var photo_1 = FORGE.createElement({width: 160, height: 600, parent: banner});
      var photo_1_bg = FORGE.createElement({backgroundImage: "photo_1_bg.jpg", parent: photo_1});
    var stamp_locomotive = FORGE.createElement({width: 394, height: 351, left: 15, top: 546, parent: banner});

    var photo_2 = FORGE.createElement({width: 312, height: 600, parent: banner});
      ...
      var photo_2_wheel = FORGE.createElement({backgroundImage: "photo_2_wheel.png", width: 312, height: 312, left: -76, top: 120, parent: photo_2});
      var photo_2_axle = FORGE.createElement({backgroundImage: "photo_2_axle.png", left: -74, top: 190, width: 176, height: 98, parent: photo_2});
      var photo_2_gradient = FORGE.createElement({backgroundImage: "photo_2_gradient.png", left: -76, top: 120, width: 312, height: 312, parent: photo_2});

    var separator_1 = FORGE.createElement({width: 98, height: 14, left: 6, top: 475, parent: banner});
    ...
    var txt_1 = FORGE.createElement({width: 150, height: 38, left: 4, top: 29, parent: banner});
      var txt_1_1 = FORGE.createElement({width: 150, height: 38, parent: txt_1});
        var txt_1_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 150, height: 38, opacity: 0, parent: txt_1_1});
        var txt_1_1_txt = FORGE.createElement({backgroundImage: "txt_1_1_txt.png", left: 0, top: 0, retina: true, parent: txt_1_1});

    var txt_2 = FORGE.createElement({width: 144, height: 164, left: -6, top: 332, parent: banner});

      var txt_2_1 = FORGE.createElement({width: 144, height: 29, parent: txt_2});
        var txt_2_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 144, height: 29, opacity: 0, parent: txt_2_1});
        var txt_2_1_base = FORGE.createElement({backgroundImage: "txt_2_1_base.png", left: 5, top: 0, retina: true, parent: txt_2_1});

      var txt_2_2 = FORGE.createElement({width: 144, height: 29, top: 34, parent: txt_2});
        var txt_2_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 144, height: 29, opacity: 0, parent: txt_2_2});
        var txt_2_2_base = FORGE.createElement({backgroundImage: "txt_2_2_base.png", left: 5, top: 0, retina: true, parent: txt_2_2});

      var txt_2_3 = FORGE.createElement({width: 144, height: 29, top: 68, parent: txt_2});
        var txt_2_3_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 144, height: 29, opacity: 0, parent: txt_2_3});
        var txt_2_3_base = FORGE.createElement({backgroundImage: "txt_2_3_base.png", left: 5, top: 0, retina: true, parent: txt_2_3});

      var txt_2_4 = FORGE.createElement({width: 144, height: 29, top: 102, parent: txt_2});
        var txt_2_4_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 144, height: 29, opacity: 0, parent: txt_2_4});
        var txt_2_4_base = FORGE.createElement({backgroundImage: "txt_2_4_base.png", left: 5, top: 0, retina: true, parent: txt_2_4});

      var txt_2_5 = FORGE.createElement({width: 144, height: 29, top: 136, parent: txt_2});
        var txt_2_5_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 144, height: 29, opacity: 0, parent: txt_2_5});
        var txt_2_5_base = FORGE.createElement({backgroundImage: "txt_2_5_base.png", left: 5, top: 0, retina: true, parent: txt_2_5});

    var txt_3 = FORGE.createElement({width: 127, height: 162, left: 17, top: 282, parent: banner});
      var txt_3_1 = FORGE.createElement({width: 127, height: 26, parent: txt_3});
        var txt_3_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 127, height: 26, opacity: 0, parent: txt_3_1});
        var txt_3_1_base = FORGE.createElement({backgroundImage: "txt_3_1_base.png", left: 0, top: 0, retina: true, parent: txt_3_1});

      var txt_3_2 = FORGE.createElement({width: 127, height: 26, top: 34, parent: txt_3});
        var txt_3_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 127, height: 26, opacity: 0, parent: txt_3_2});
        var txt_3_2_base = FORGE.createElement({backgroundImage: "txt_3_2_base.png", left: 0, top: 0, retina: true, parent: txt_3_2});

      var txt_3_3 = FORGE.createElement({width: 127, height: 26, top: 68, parent: txt_3});
        var txt_3_3_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 127, height: 26, opacity: 0, parent: txt_3_3});
        var txt_3_3_base = FORGE.createElement({backgroundImage: "txt_3_3_base.png", left: 0, top: 0, retina: true, parent: txt_3_3});

      var txt_3_4 = FORGE.createElement({width: 127, height: 26, top: 102, parent: txt_3});
        var txt_3_4_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 127, height: 26, opacity: 0, parent: txt_3_4});
        var txt_3_4_base = FORGE.createElement({backgroundImage: "txt_3_4_base.png", left: 0, top: 0, retina: true, parent: txt_3_4});

      var txt_3_5 = FORGE.createElement({width: 127, height: 26, top: 136, parent: txt_3});
        var txt_3_5_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 127, height: 26, opacity: 0, parent: txt_3_5});
        var txt_3_5_base = FORGE.createElement({backgroundImage: "txt_3_5_base.png", left: 0, top: 0, retina: true, parent: txt_3_5});

    var panel = FORGE.createElement({width: 160, height: 600, left: 0, top: 0, parent: banner});
    var photo_3_bg = FORGE.createElement({backgroundImage: "photo_3_bg.jpg", width: 160, height: 600, left: 0, top: 0, parent: panel});

      var panel_base = FORGE.createElement({backgroundColor: "#333333", width: 150, height: 584,left: 5, top: 8, opacity: 0.9, parent: panel});
      var logo_locomotive = FORGE.createElement({width: 135, height: 120, left: 12, top: 210, parent: panel});
      ...
      var separator_2 = FORGE.createElement({width: 133, height: 10, left: 14, top: 427, parent: panel});
        var separator_1_3 = FORGE.createElement({backgroundImage: "separator_1_3.png", width: 133, height: 10, left: 0, top: 2, retina: true, parent: separator_2});

      var txt_4 = FORGE.createElement({width: 160, height: 46, left: -5, top: 370, parent: panel});
        var txt_4_1 = FORGE.createElement({width: 160, height: 21, parent: txt_4});
          var txt_4_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 160, height: 25, opacity: 0, parent: txt_4_1});
          var txt_4_1_base = FORGE.createElement({backgroundImage: "txt_4_1_base.png", left: 0, top: 0, retina: true, parent: txt_4_1});

        var txt_4_2 = FORGE.createElement({width: 160, height: 21, top: 25, left: 0, parent: txt_4});
          var txt_4_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 192, height: 23, opacity: 0, parent: txt_4_2});
          var txt_4_2_base = FORGE.createElement({backgroundImage: "txt_4_2_base.png", left: 5, top: 0, retina: true, parent: txt_4_2});

      var cta = FORGE.createElement({width: 96, height: 25, left: 33, top: 472, parent: panel});
        var cta_right = FORGE.createElement({width: 72, height: 25, left: 23, parent: cta});
          var cta_right_base = FORGE.createElement({backgroundImage: "cta_right_base.png", left: 0, width: 72, height: 25, retina: true, parent: cta_right});
          var cta_right_reflection = FORGE.createElement({backgroundColor: "#ffffff", width: 3, height: 43, left: 0, top: 0, parent: cta_right});
          var cta_right_txt = FORGE.createElement({backgroundImage: "cta_right_txt.png",  width: 52, height: 13, left: 10, top: 7, retina: true, parent: cta_right});
          var cta_right_light = FORGE.createElement({backgroundImage: "cta_right_light.png", left: 0, width: 72, height: 25, opacity: 0, retina: true, parent: cta_right});

        var cta_left = FORGE.createElement({width: 23, height: 25, parent: cta});
          var cta_left_base = FORGE.createElement({backgroundImage: "cta_left_base.png", width: 23, height: 25, retina: true, parent: cta_left});
          var cta_left_txt = FORGE.createElement({backgroundImage: "cta_left_txt.png", width: 7, left: 7, top: 8,  height: 10, retina: true, parent: cta_left});
    ...
    cta.in = new FORGE.Timeline()
      ...
      .fromTo(cta, 0.3, {x: -50}, {x: 2, ease: Power1.easeOut})
      .chain()
      .add(ctaOver);
