FORGE.init = function() {
  ...
  FORGE.preloadImages(images, true, function() {
    ...
    /* Create elements
    ================================================= */
    var bg = FORGE.createElement({backgroundColor: "#333333", width: 320, height: 50, parent: banner});
    var photo_1 = FORGE.createElement({width: 320, height: 50, parent: banner});
      var photo_1_bg = FORGE.createElement({backgroundImage: "photo_1_bg.jpg", parent: photo_1});
    var stamp_locomotive = FORGE.createElement({width: 394, height: 351, left: 170, top: 15, parent: banner});
    var photo_2 = FORGE.createElement({width: 320, height: 50, parent: banner});
      ...
      var photo_2_wheel = FORGE.createElement({backgroundImage: "photo_2_wheel.png", width: 123, height: 123, left: 100, top: -39, parent: photo_2});
      var photo_2_axle = FORGE.createElement({backgroundImage: "photo_2_axle.png", top: -14, left: 97, width: 69, height: 38, parent: photo_2});
      var photo_2_gradient = FORGE.createElement({backgroundImage: "photo_2_gradient.png", top: -100, left: 0, width: 728 , height: 300, opacity: 0.6, parent: photo_2});
    var separator_1 = FORGE.createElement({width: 54, height: 4, left: 163, top: 42, parent: banner});
      var separator_1_1 = FORGE.createElement({backgroundImage: "separator_1_1.png", width: 54, height: 4, top: 0, retina: true, parent: separator_1});
      //var separator_1_2 = FORGE.createElement({backgroundImage: "separator_1_2.png", left: 57, retina: true, parent: separator_1});
    var txt_1 = FORGE.createElement({width: 68, height: 16, left: 6, top: 6, parent: banner});
      var txt_1_1 = FORGE.createElement({width: 68, height: 16, parent: txt_1});
        var txt_1_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 68, height: 16, opacity: 0, parent: txt_1_1});
        var txt_1_1_txt = FORGE.createElement({backgroundImage: "txt_1_1_txt.png", width: 68, height: 16, left: 0, top: 0, retina: true, parent: txt_1_1});

    var txt_2 = FORGE.createElement({width: 135, height: 31, left: 152, top: 8, parent: banner});

      var txt_2_1 = FORGE.createElement({width: 135, height: 16, parent: txt_2});
        var txt_2_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 135, height: 16, opacity: 0, parent: txt_2_1});
        var txt_2_1_base = FORGE.createElement({backgroundImage: "txt_2_1_base.png", width: 135, height: 16, left: 5, top: 0, retina: true, parent: txt_2_1});

      var txt_2_2 = FORGE.createElement({width: 135, height: 16, top: 15, parent: txt_2});
        var txt_2_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 135, height: 16, opacity: 0, parent: txt_2_2});
        var txt_2_2_base = FORGE.createElement({backgroundImage: "txt_2_2_base.png", width: 135, height: 16, left: 5, top: 0, retina: true, parent: txt_2_2});



    var txt_3 = FORGE.createElement({width: 141, height: 27, left: 159, top: 10, parent: banner});
      var txt_3_1 = FORGE.createElement({width: 141, height: 12, parent: txt_3});
        var txt_3_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 141, height: 12, opacity: 0, parent: txt_3_1});
        var txt_3_1_base = FORGE.createElement({backgroundImage: "txt_3_1_base.png", width: 141, height: 12, left: 0, top: 0, retina: true, parent: txt_3_1});

      var txt_3_2 = FORGE.createElement({width: 141, height: 12, top: 15, parent: txt_3});
        var txt_3_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 141, height: 12, opacity: 0, parent: txt_3_2});
        var txt_3_2_base = FORGE.createElement({backgroundImage: "txt_3_2_base.png", width: 141, height: 12, left: 0, top: 0, retina: true, parent: txt_3_2});



    var panel = FORGE.createElement({width: 320, height: 90, left: 0, top: 0, parent: banner});
    var photo_3_bg = FORGE.createElement({backgroundImage: "photo_3_bg.jpg", width: 320, height: 90, left: 0, top: 0, parent: panel});

      var panel_base = FORGE.createElement({backgroundColor: "#333333", width: 719, height: 81, left: 4, top: 5, opacity: 0.9, parent: panel});
      var logo_locomotive = FORGE.createElement({width: 72, height: 64, left: 124, top: -7, parent: panel});
       // var logo_locomotive_base = FORGE.createElement({backgroundImage: "logo_locomotive_base.png", width: 223, height: 198, left: 39, top: 186, retina: true, parent: panel});
        var logo_locomotive_outlines = FORGE.createElement({backgroundImage: "logo_locomotive_outlines.png", width: 72, height: 64, left: 1, retina: true, parent: logo_locomotive});

      var separator_2 = FORGE.createElement({width: 60, height: 5, left: 21, top: 39, parent: panel});
        var separator_1_3 = FORGE.createElement({backgroundImage: "separator_1_3.png", width: 60, height: 5, left: 0, top: 2, retina: true, parent: separator_2});

      var txt_4 = FORGE.createElement({width: 83, height: 25, left: 12, top: 10, parent: panel});
        var txt_4_1 = FORGE.createElement({width: 48, height: 11, left: 18, parent: txt_4});
          var txt_4_1_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 48, height: 11, opacity: 0, parent: txt_4_1});
          var txt_4_1_base = FORGE.createElement({backgroundImage: "txt_4_1_base.png", width: 48, height: 11, left: 0, top: 0, retina: true, parent: txt_4_1});

        var txt_4_2 = FORGE.createElement({width: 83, height: 10, top: 14, left: 0, parent: txt_4});
          var txt_4_2_mask = FORGE.createElement({backgroundColor: "#00ffff", width: 83, height: 10, opacity: 0, parent: txt_4_2});
          var txt_4_2_base = FORGE.createElement({backgroundImage: "txt_4_2_base.png", width: 83, height: 10, left: 0, top: 0, retina: true, parent: txt_4_2});
 
      var cta = FORGE.createElement({width: 132, height: 34, left: 190, top: 10, parent: panel});
        ...
        var cta_right = FORGE.createElement({width: 132, height: 34, left: 0, parent: cta});
          ...
          var cta_right_reflection = FORGE.createElement({backgroundColor: "#ffffff", width: 5, height: 43, left: 33, top: 0, parent: cta_right});
    ...
    var ctaOver = function() {
      if (!ctaActive) {
        ...
        return new FORGE.Timeline()
          ...
          .to(cta_right_reflection, 0.5, {x: 100, opacity: 0, ease: Power2.easeOut})
          .offset(0.16)
    ...
    photo_2.in = new FORGE.Timeline()
      ...
      .from(photo_2_axle, 4.55, {y: 20, ease: Power1.easeOut})
    ...
    cta.in = new FORGE.Timeline()
      ...
      .fromTo(cta, 0.3, {x: -20, opacity: 0}, {x: 0, opacity: 1, ease: Power1.easeOut})
      .chain()
      .add(ctaOver);
