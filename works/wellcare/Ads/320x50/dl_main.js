...
var _tt = new TimelineMax();
    ...
    .set("[id*='Logo']", {scale: 1.4, x: -1})
    .set("[id*='CTA']", { x: 6})

    .fromTo("[id*='contbg']", 2, {ease: Expo.easeOut, scale: 0.24, autoAlpha: 0, x: 70, y: 10}, {scale: 0.24, autoAlpha: 1, x: 70, y: 10}, 0)
    //.from("[id*='Eyes-'] img", 3, {ease: Expo.easeOut, x: 50}, 0)

    .to("[id*='contbg']", 3, {ease: Expo.easeOut, scale: 0.24, autoAlpha: 0,  force3D:false, rotation:0.01}, 1.8)

    .from("[id*='Logo']", 2, {ease: Expo.easeOut, autoAlpha: 0}, 2.2)
    .staggerFrom("[id*='Text-1'], [id*='Text-2']", 1, {ease: Expo.easeOut, y: 100, autoAlpha: 0}, 0.4, 2.4)
    .from("[id*='CTA']", 1, {ease: Back.easeOut.config(0.5), y: 200}, 2.7)
