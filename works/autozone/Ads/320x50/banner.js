FORGE.init = function() {
  ...
  FORGE.preloadImages(images, true, function() {
    ...
    /* Create elements
    ================================================= */
    var Fr1 = FORGE.createElement({backgroundImage: "Fr1-bg.jpg", width: 320, height: 50, parent: banner});
    var txt_1 = FORGE.createElement({backgroundImage: "txt1.png", width: 320, height: 50, parent: banner});

    var Fr2 = FORGE.createElement({width: 320, height: 50, parent: banner});
    var Fr2_bg = FORGE.createElement({backgroundImage: "Fr2-bg.jpg", width: 320, height: 50, parent: Fr2});

    var txt_2 = FORGE.createElement({width: 320, height: 50, parent: banner});
    var txt_2_bg = FORGE.createElement({backgroundImage: "txt2.png", width: 320, height: 50, parent: txt_2});


    var elementBar = FORGE.createElement({width: 320, height: 50, parent: banner});
    var elementBar_bg = FORGE.createElement({backgroundImage: "ElementBar.png", parent: elementBar});



    var Wiper = FORGE.createElement({backgroundImage: "Wiper.png", width: 320, height: 50, left: 0, top: 0, parent: banner});


    var txt_3 = FORGE.createElement({backgroundImage: "txt3.png", width: 320, height: 50, parent: banner});

    var AutoZoneLogo = FORGE.createElement({backgroundImage: "AutoZone-Logo.png", width: 320, height: 50, parent: banner});

    var CTA = FORGE.createElement({backgroundImage: "CTA.png", left: 125, top: 25, width: 82, height: 16, retina: true, parent: banner});
    var BoshLogo = FORGE.createElement({backgroundImage: "BoshLogo.png", width: 320, height: 50, parent: banner});
   ...
   // var imageWipeMask = createImageWipeMask();
    ...
    function fadeInLeft(obj) {
      ...
      .from(obj, 1, {opacity: 0, x: 15, ease: Power3.easeOut});
    }


    function slideOutLeft(obj) {
      return new FORGE.Timeline()
      .to(obj, 1.5, { x: -320, ease: Power3.easeOut});
    }
    ...
    function slideInUp(obj) {
      return new FORGE.Timeline()
      .from(obj, 1, { y: 50, ease: Power3.easeOut});
    }


    function slideInLeft(obj) {
      return new FORGE.Timeline()
      .from(obj, 1.5, { x: 320, ease: Power3.easeOut});
    }


    Wiper.in = new FORGE.Timeline()
      .fromTo(Wiper, 1.5, {x: -320, ease: Power2.easeInOut}, { x: 20})
    ;
    var rectMaskIn = function(obj) {
      return new FORGE.Timeline()
        .fromTo(obj, 1.5, {clip: 'clip:"rect(0px 0px 50px 0px)', ease: Power2.easeIn}, {clip: 'clip:"rect(0px 320px 320px 0px)'});
    }
