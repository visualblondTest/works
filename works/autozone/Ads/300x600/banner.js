FORGE.init = function() {
  ...
  FORGE.preloadImages(images, true, function() {
    ...
    /* Create elements
    ================================================= */
    var Fr1 = FORGE.createElement({backgroundImage: "Fr1-bg.jpg", width: 300, height: 600, parent: banner});
    var txt1 = FORGE.createElement({ width: 300, height: 600, parent: banner});

    var txt1_1 = FORGE.createElement({backgroundImage: "txt1-1.png", width: 300, height: 600, parent: txt1});
    var txt1_2 = FORGE.createElement({backgroundImage: "txt1-2.png", width: 300, height: 600, parent: txt1});
    var txt1_3 = FORGE.createElement({backgroundImage: "txt1-3.png", width: 300, height: 600, parent: txt1});
    var txt1_4 = FORGE.createElement({backgroundImage: "txt1-4.png", width: 300, height: 600, parent: txt1});

    var Fr2 = FORGE.imageCache["Fr2-bg.jpg"];

    var canvas = FORGE.createElement({type: "canvas", width: 300, height: 600, parent: banner});

    var Wiper = FORGE.createElement({backgroundImage: "Wiper.png", width: 300, height: 650, left: 0, top: -5, parent: banner});




    var Fr6 = FORGE.createElement({backgroundImage: "Fr6-bg.jpg", width: 300, height: 600, parent: banner});
    var txt4 = FORGE.createElement({backgroundImage: "txt4.png", width: 300, height: 600, parent: Fr6});
    var AutoZoneLogo = FORGE.createElement({backgroundImage: "AutoZone-Logo.png", width: 300, height: 600, parent: Fr6});
    var elementBar = FORGE.createElement({backgroundImage: "ElementBar.png", width: 300, height: 600, parent: Fr6});


    var contCTA = FORGE.createElement({width: 300, height: 600, parent: banner});
    var CTA = FORGE.createElement({backgroundImage: "CTA.png", left: 172, top: 403, width: 101, height: 31, retina: true, parent: contCTA});
    var BoshLogo = FORGE.createElement({backgroundImage: "BoshLogo.png", width: 300, height: 600, parent: contCTA});

   // var txt3 = FORGE.imageCache["txt3.png"];

   // var txt3 = FORGE.createElement({backgroundImage: "txt3.png", width: 300, height: 600, parent: banner});
   ...
   // var imageWipeMask = createImageWipeMask();
    ...
    Wiper.set({transformOrigin:'150px 645px 0px'});
    ...
    Wiper.in = new FORGE.Timeline()
      .fromTo(Wiper, 3.5, {rotation: -100, x: 0, ease: Power0.easeNone}, {rotation: 105, x: 0})
    ;
   ...
   /* elementBar.in = new FORGE.Timeline()
      .to(elementBar, 1, {y: -600, ease: Power3.easeOut})
    ;*/

    contCTA.in = new FORGE.Timeline()
      .from(contCTA, 1, {x: 300, ease: Power3.easeOut})
    ;    
